document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ua: {
            nav_services: "Послуги", nav_equip: "Обладнання", nav_how: "Як ми працюємо", nav_contacts: "Контакти",
            btn_request: "Залишити заявку", hero_title: "Прання килимів у<br>Дніпрі: 100 грн/м²",
            hero_subtext: "Заберемо, почистимо на професійному обладнанні та привеземо сухим через 3–7 днів",
            ...
            price_clothes: "350 грн / шт", blanket_h: "Прання пледів та ковдр",
            ...
            f_city: "Дніпро, Україна", f_contacts_h: "Контакти", f_social_h: "Ми в мережах",
            ...
            q2: "Чи виводите ви запах сечі?", a2_faq: "Так, ми використовуємо спеціалізовану хімію, яка розщеплює джерело запаху на молекулярному рівні.",
            q3: "Ви перете на автомийці?", a3_faq: "Ні! У нас професійний цех з центрифугою та камерою для сушіння."
        },
        ru: {
            nav_services: "Услуги", nav_equip: "Оборудование", nav_how: "Как мы работаем", nav_contacts: "Контакты",
            btn_request: "Оставить заявку", hero_title: "Стирка ковров в<br>Днепре: 100 грн/м²",
            hero_subtext: "Заберем, почистим на профессиональном оборудовании и привезем сухим через 3–7 дней",
            ...
            price_clothes: "350 грн / шт", blanket_h: "Стирка пледов и одеял",
            ...
            q2: "Выводите ли вы запах мочи?", a2_faq: "Да, мы используем специализированную химию, которая расщепляет источник запаха на молекулярному уровне.",
